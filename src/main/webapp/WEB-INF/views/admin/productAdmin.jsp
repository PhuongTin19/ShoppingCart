                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
	                                        <c:forEach var="products" items="${products}">
	                                            <tr >
	                                            	 <td>
	                                            		 <img src="/img/${products.image}" alt="your image"  width="100" class="img-fluid img-thumbnail"/>
	                                            	</td>
	                                      <!---->   <td>${products.name}</td>
	                                                ...
	                                                <td align="center">
	                                                    <a class="btn btn-success" href="/admin/product/edit?image=${products.image}&id=${products.id}&name=${products.name}&price=${products.price}&description=${products.description}
	                                                    &quantity=${products.quantity}&color.name=${products.color.name}">
															<i class="fa fa-edit" aria-hidden="true"></i>
														</a>
	                                                    <a class="btn btn-danger"  href="/admin/product/delete?name=${products.name}">
